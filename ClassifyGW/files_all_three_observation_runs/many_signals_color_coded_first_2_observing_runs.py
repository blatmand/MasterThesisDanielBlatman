...
plt.tight_layout()
plt.savefig("Many_signals_masses_plot_C_"+str(C)+"gamma_"+str(gamma))
plt.close()
...
plt.savefig("Many_signals_average_accuracy_"+attribute+"_C_"+str(C)+"gamma_"+str(gamma))  
plt.close()